                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs" id="settings_tabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="scripts-tab" data-toggle="tab" href="#scripts" role="tab"
                                               aria-controls="scripts" aria-selected="false">Scripts</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content" id="settings_tab_content">
                                        ...
                                        <div class="tab-pane fade" id="scripts" role="tabpanel" aria-labelledby="sensors-tab">
                                            <div class="table-responsive p-0">
                                                <table class="table table-hover">
                                                    <thead>
                                                    <tr>
                                                    ...
                                                    <tbody>
                                                    <tr v-for="device in devices.script"
                                                        :key="device.entity_id">
                                                        <td :title="device.entity_id">{{ device.attributes.friendly_name }}</td>
                                                        <td>{{ device.state }}</td>
                                                        <td>
